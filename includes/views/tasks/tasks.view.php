<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////////////////////
 var controller = 'tasks_controller';
 var TABLE_DATA = []; 
 var itemsPerPage = null;
 </script> 
 <!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-tasks' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
 	<div class='xxxpagination_page' >
 		<div class='row top-row'>
 			<div class='col-md-12'>
 				<h3><?= $_SESSION['parent_name']; ?>: tasks</h3>
  <button class='create_btn' >+</button> 
				<!-- hidden anchor that calls the modal -->
 				<a id='modal-tasks' style='' href='#modal-container-tasks' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 				<!-- ======================================================  -->
 				<div class='row'>
...
<div class="row text-center">
	                        <div class="col-lg-1">
	                            <button onclick='tasksSummary();' class="txt-bold">
	                                Tasks Summary
	                            </button>
	                        </div>
                		</div>
...
<th>est_dt</th>
 ...
 function load_data(){
 	var dataString = "c=tasks_controller&m=readToJSONByParentId&data_only=true";
 ...
 //  POPULATE DETAILS PANEL  /////////////////////////////////////////////////////////////////////////////////
  function rowClick(i) {
 	...
 	document.getElementById('modal-tasks').click();
 ...
 html += "<div class='row'><h3><!-- <a  style='color:green;' href='<?=BASE_URL;?>index.php?c=subtasks_controller&m=read_parent_id&parent_id="+TABLE_DATA[i]['id']+"'> details </a> --> </h3></div> "; html += "<input type='hidden' id='id'  name='id' class='info' value='"+TABLE_DATA[i]['id']+"' />";html += "<input type='hidden' id='parent_id'  name='parent_id' class='info' value='"+TABLE_DATA[i]['parent_id']+"' />"; 
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
 function save_create(id) {
	...
	break;				default:
 	...
 	var dataString = 'c=tasks_controller&m=create&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=tasks_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=tasks_controller&m=edit&'+params;
 ...
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=tasks_controller&m=delete&id=' + data.id  ;
