<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////////////////////
 var controller = 'snips_controller';
 var TABLE_DATA = []; 
 var itemsPerPage = null;
 </script> 
 <!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-snips' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
  ...
  <button class='create_btn' >+</button> 
				<!-- hidden anchor that calls the modal -->
 				<a id='modal-snips' style='' href='#modal-container-snips' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 				<!-- ======================================================  -->
 				<div class='row'>
...
<th>modified</th>
 ...
 function load_data(){
 	var dataString = "c=snips_controller&m=readToJSON&data_only=true";
 ...
 //  POPULATE DETAILS PANEL  /////////////////////////////////////////////////////////////////////////////////
  function rowClick(i) {
 	var table_header =  'snips' ;
 	document.getElementById('modal-snips').click();
	 ...
	 html += "<div class='row'>";
	 // <div class='col-md-6 text-right' >description:</div><div class='col-md-6 text-left'><input type='text' id='description'  name='description' class='info' value='"+TABLE_DATA[i]['description']+"' /> </div>
	  html += "<div class='col-xs-12 col-sm-12 col-md-3 col-lg-3  '>description:</div>";
            html += "<div class='col-xs-12 col-sm-12 col-md-9 col-lg-9  '>";
            //html += "<input type='text' id='description'  name='description' class='info' value='" + TABLE_DATA[i]['description'] + "' /> ";
...
/*
	 html += "<div class='row'><div class='col-md-6 text-right' >code:</div><div class='col-md-6 text-left'><input type='text' id='code'  name='code' class='info' value='"+TABLE_DATA[i]['code']+"' /> </div></div>" ;*/
 html += "<div class='col-xs-12 col-sm-12 col-md-3 col-lg-3  '>code:</div>";
            html += "<div class='col-xs-12 col-sm-12 col-md-9 col-lg-9  '>";
            //html += "<input type='text' id='description'  name='description' class='info' value='" + TABLE_DATA[i]['description'] + "' /> ";
             html += "<textarea   id='code'  name='code' class='info'  class='modal-text-area'>" + TABLE_DATA[i]['code'] + "</textarea>  ";
            html += "</div>";
	 html += "</div>" ;


	 html += "<div class='row'><div class='col-md-6 text-right' >language:</div><div class='col-md-6 text-left'><input type='text' id='language'  name='language' class='info' value='"+TABLE_DATA[i]['language']+"' /> </div></div>" 
	 html += "<div class='row'><div class='col-md-6 text-right' >created:</div><div class='col-md-6 text-left'><input type='text' id='created'  name='created' class='info' value='"+TABLE_DATA[i]['created']+"' /> </div></div>" 
	 html += "<div class='row'><div class='col-md-6 text-right' >modified:</div><div class='col-md-6 text-left'><input type='text' id='modified'  name='modified' class='info' value='"+TABLE_DATA[i]['modified']+"' /> </div></div>" 
		html +="<div class='row'>";
 ...
 $('.create_btn').click(function() { 
	...
	document.getElementById('modal-snips').click();
	 ...
	 html += "<div class='row'><div class='col-md-6 text-right' >code:</div><div class='col-md-6 text-left'><input type='text' id='code'  name='code' class='info' value='' /></div></div>" 

	 html += "<div class='row'><div class='col-md-6 text-right' >language:</div><div class='col-md-6 text-left'><input type='text' id='language'  name='language' class='info' value='' /></div></div>" 

	 html += "<div class='row'><div class='col-md-6 text-right' >created:</div><div class='col-md-6 text-left'><input type='text' id='created'  name='created' class='info' value='' /></div></div>" 

	 html += "<div class='row'><div class='col-md-6 text-right' >modified:</div><div class='col-md-6 text-left'><input type='text' id='modified'  name='modified' class='info' value='' /></div></div>" 
		html +="<div class='row'>"; 
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
 function save_create(id) {
	...
	break;				default:
 	...
 	var dataString = 'c=snips_controller&m=create&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=snips_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=snips_controller&m=edit&'+params;
 ...
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=snips_controller&m=delete&id=' + data.id  ;
