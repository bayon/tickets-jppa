<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////////////////////
 var controller = 'ux_emails_controller';
 var TABLE_DATA = []; 
 var itemsPerPage = null;
 </script> 
 <!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-ux_emails' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
  ...
  <button class='create_btn' >+</button> 
				<!-- hidden anchor that calls the modal -->
 				<a id='modal-ux_emails' style='' href='#modal-container-ux_emails' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 				<!-- ======================================================  -->
 				<div class='row'>
...
<th>created</th>
 ...
 function load_data(){
 	var dataString = "c=ux_emails_controller&m=readToJSON&data_only=true";
 ...
 //  POPULATE DETAILS PANEL  /////////////////////////////////////////////////////////////////////////////////
  function rowClick(i) {
 	var table_header =  'ux_emails' ;
 	document.getElementById('modal-ux_emails').click();
	 ...
	 html += "<div class='row'><div class='col-md-6 text-right' >assigned:</div><div class='col-md-6 text-left'><input type='text' id='assigned'  name='assigned' class='info' value='"+TABLE_DATA[i]['assigned']+"' /> </div></div>" 
 ...
 $('.create_btn').click(function() { 
	...
	document.getElementById('modal-ux_emails').click();
	 ...
	 html += "<div class='row'><div class='col-md-6 text-right' >assigned:</div><div class='col-md-6 text-left'><input type='text' id='assigned'  name='assigned' class='info' value='' /></div></div>" 
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
 function save_create(id) {
	...
	break;				default:
 	...
 	var dataString = 'c=ux_emails_controller&m=create&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=ux_emails_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=ux_emails_controller&m=edit&'+params;
 ...
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=ux_emails_controller&m=delete&id=' + data.id  ;
