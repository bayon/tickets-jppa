<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////////////////////
 var controller = 'webtickets_controller';
 var TABLE_DATA = []; 
 var itemsPerPage = null;
 </script> 
 <!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-webtickets' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
  ...
  <button class='create_btn' >+</button> 
				<!-- hidden anchor that calls the modal -->
 				<a id='modal-webtickets' style='' href='#modal-container-webtickets' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 				<!-- ======================================================  -->
 				<div class='row'>
...
<th>phase3</th>
 ...
 html += '<td>' + row.name + '</td>';
 html += '<td>' + row.date + '</td>';
 html += '<td>' + row.phase1 + '</td>';
 html += '<td>' + row.phase2 + '</td>';
 html += '<td>' + row.phase3 + '</td>';
 				html += '</tr>';
 				rows.push(html);
 			}
 		});
 ...
 function load_data(){
 	var dataString = "c=webtickets_controller&m=readToJSONByParentId&data_only=true";
 ...
 //  POPULATE DETAILS PANEL  /////////////////////////////////////////////////////////////////////////////////
  function rowClick(i) {
 	var table_header =  'webtickets' ;
 	document.getElementById('modal-webtickets').click();
 ...
 html += "<div class='row'><h3><a  style='color:green;' href='<?=BASE_URL;?>index.php?c=xxx_controller&m=read_parent_id&parent_id="+TABLE_DATA[i]['id']+"'> details </a></h3></div> "; html += "<input type='hidden' id='id'  name='id' class='info' value='"+TABLE_DATA[i]['id']+"' />";html += "<input type='hidden' id='parent_id'  name='parent_id' class='info' value='"+TABLE_DATA[i]['parent_id']+"' />"; 
	 ...
	 html += "<div class='row'><div class='col-md-6 text-right' >date:</div><div class='col-md-6 text-left'><input type='text' id='date'  name='date' class='info' value='"+TABLE_DATA[i]['date']+"' /> </div></div>" 
	 html += "<div class='row'><div class='col-md-6 text-right' >phase1:</div><div class='col-md-6 text-left'><input type='text' id='phase1'  name='phase1' class='info' value='"+TABLE_DATA[i]['phase1']+"' /> </div></div>" 
	 html += "<div class='row'><div class='col-md-6 text-right' >phase2:</div><div class='col-md-6 text-left'><input type='text' id='phase2'  name='phase2' class='info' value='"+TABLE_DATA[i]['phase2']+"' /> </div></div>" 
	 html += "<div class='row'><div class='col-md-6 text-right' >phase3:</div><div class='col-md-6 text-left'><input type='text' id='phase3'  name='phase3' class='info' value='"+TABLE_DATA[i]['phase3']+"' /> </div></div>" 
		html +="<div class='row'>";
 ...
 $('.create_btn').click(function() { 
	...
	document.getElementById('modal-webtickets').click();
	 ...
	 html += "<div class='row'><div class='col-md-6 text-right' >date:</div><div class='col-md-6 text-left'><input type='text' id='date'  name='date' class='info' value='' /></div></div>" 

	 html += "<div class='row'><div class='col-md-6 text-right' >phase1:</div><div class='col-md-6 text-left'><input type='text' id='phase1'  name='phase1' class='info' value='' /></div></div>" 

	 html += "<div class='row'><div class='col-md-6 text-right' >phase2:</div><div class='col-md-6 text-left'><input type='text' id='phase2'  name='phase2' class='info' value='' /></div></div>" 

	 html += "<div class='row'><div class='col-md-6 text-right' >phase3:</div><div class='col-md-6 text-left'><input type='text' id='phase3'  name='phase3' class='info' value='' /></div></div>" 
		html +="<div class='row'>"; 
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
 function save_create(id) {
	...
	break;				default:
 	...
 	var dataString = 'c=webtickets_controller&m=create&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=webtickets_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=webtickets_controller&m=edit&'+params;
 ...
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=webtickets_controller&m=delete&id=' + data.id  ;
