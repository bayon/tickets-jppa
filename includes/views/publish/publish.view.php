<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////////////////////
 var controller = 'publish_controller';
 var TABLE_DATA = []; 
 var itemsPerPage = null;
 </script> 
 <!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-publish' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
  ...
  <button class='create_btn' >+</button> 
				<!-- hidden anchor that calls the modal -->
 				<a id='modal-publish' style='' href='#modal-container-publish' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 				<!-- ======================================================  -->
 				<div class='row'>
...
<th>published</th>
 ...
 function load_data(){
 	var dataString = "c=publish_controller&m=readToJSON&data_only=true";
 ...
 //  POPULATE DETAILS PANEL  /////////////////////////////////////////////////////////////////////////////////
  function rowClick(i) {
 	var table_header =  'publish' ;
 	document.getElementById('modal-publish').click();
	 ...
	 html += "<p>admin_id:<input type='text' id='admin_id'  name='admin_id' class='info' value='"+TABLE_DATA[i]['admin_id']+"' /> </p>" 
	 html += "<p>doc_id:<input type='text' id='doc_id'  name='doc_id' class='info' value='"+TABLE_DATA[i]['doc_id']+"' /> </p>" 
	 html += "<p>published:<input type='text' id='published'  name='published' class='info' value='"+TABLE_DATA[i]['published']+"' /> </p>" 
 ...
 $('.create_btn').click(function() { 
	...
	document.getElementById('modal-publish').click();
	 ...
	 html += "<p>admin_id:<input type='text' id='admin_id'  name='admin_id' class='info' value='' /></p>" 

	 html += "<p>doc_id:<input type='text' id='doc_id'  name='doc_id' class='info' value='' /></p>" 

	 html += "<p>published:<input type='text' id='published'  name='published' class='info' value='' /></p>" 
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
 function save_create(id) {
	...
	break;
	case 'admin_id':
	data.admin_id = e.value;
	break;
	case 'doc_id':
	data.doc_id = e.value;
	break;
	case 'published':
	data.published = e.value;
	break;				default:
 				//default code block
 				break;
 			}
 	...
 	var dataString = 'c=publish_controller&m=create&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=publish_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=publish_controller&m=edit&'+params;
 ...
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=publish_controller&m=delete&id=' + data.id  ;
