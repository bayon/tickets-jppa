<script>
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////////////////////
 var controller = 'record_controller';
 var TABLE_DATA = [];
 ...
 <!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-record' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
  ...
  <button class='create_btn' >+</button>
				<!-- hidden anchor that calls the modal -->
 				<a id='modal-record' style='' href='#modal-container-record' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 				<!-- ======================================================  -->
 				<div class='row'>
...
<th>updated</th>
 ...
 function load_data(){
 	var dataString = "c=record_controller&m=readToJSON&data_only=true";
 ...
 //  POPULATE DETAILS PANEL  /////////////////////////////////////////////////////////////////////////////////
  function rowClick(i) {
 	var table_header =  'record' ;
 	document.getElementById('modal-record').click();
	 ...
	 html += "<div class='row'><div class='col-md-3 text-right' >doc_id:</div><div class='col-md-9 text-left'><input type='text' id='doc_id'  name='doc_id' class='info' value='"+TABLE_DATA[i]['doc_id']+"' /> </div></div>"
	 html += "<div class='row'><div class='col-md-3 text-right' >title:</div><div class='col-md-9 text-left'><input type='text' id='title'  name='title' class='info' value='"+TABLE_DATA[i]['title']+"' /></div></div>"
	 html += "<div class='row'><div class='col-md-3 text-right' >description:</div><div class='col-md-9 text-left'><input type='text' id='description'  name='description' class='info' value='"+TABLE_DATA[i]['description']+"' /> </div></div>"
	 html += "<div class='row'><div class='col-md-3 text-right' >updated:</div><div class='col-md-9 text-left'><input type='text' id='updated'  name='updated' class='info' value='"+TABLE_DATA[i]['updated']+"' /> </div></div>"
		html += " <input type='hidden' id='app_id'  name='app_id' class='info' value='" + TABLE_DATA[i]['app_id'] + "'    /> ";
html += "<div class='row'>";
     	html += "<div class='col-md-3' ><a onclick='save_edit( "  +TABLE_DATA[i]['id']+");' class='panel_anchor' data-dismiss='modal'>save</a></div>";
 	   	html += "<div class='col-md-3' ><a onclick='cancel_edit( "+TABLE_DATA[i]['id']+");' class='panel_anchor' data-dismiss='modal'>cancel</a></div>";
 ...
 $('.create_btn').click(function() {
	...
	document.getElementById('modal-record').click();
	 ...
	 html += "<div class='row'><div class='col-md-3 text-right' >id:</div><div class='col-md-9 text-left'><input type='text' id='id'  name='id' class='info' value='' /></div></div>";

	 html += "<div class='row'><div class='col-md-3 text-right' >name:</div><div class='col-md-9 text-left'><input type='text' id='name'  name='name' class='info' value=''  /></div></div>";

	 html += "<div class='row'><div class='col-md-3 text-right' >parent_id:</div><div class='col-md-9 text-left'><input type='text' id='parent_id'  name='parent_id' class='info' value='' /></div></div>";

	 html += "<div class='row'><div class='col-md-3 text-right' >doc_id:</div><div class='col-md-9 text-left'><input type='text' id='doc_id'  name='doc_id' class='info' value='' /></div></div>";

	 html += "<div class='row'><div class='col-md-3 text-right' >title:</div><div class='col-md-9 text-left'><input type='text' id='title'  name='title' class='info' value='' /></div></div>";

	 html += "<div class='row'><div class='col-md-3 text-right' >description:</div><div class='col-md-9 text-left'><input type='text' id='description'  name='description' class='info' value='' /></div></div>";

	 html += "<div class='row'><div class='col-md-3 text-right' >updated:</div><div class='col-md-9 text-left'><input type='text' id='updated'  name='updated' class='info' value='' /></div></div>";
html += "<div class='row'>";
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////
 function save_create(id) {
	...
	break;				default:
 	...
 	var dataString = 'c=record_controller&m=create&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=record_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=record_controller&m=edit&'+params;
 ...
 function edit_callback(data){
 	//alert(JS_CONFIG.BASE_URL+'?c=record_controller&m=read_parent_id&parent_id='+'<?=$_SESSION["doc_id"];?>');
 	//read_parent_id($id = "",$return = "")
 	load_data();
 	 //$(location).attr('href',JS_CONFIG.BASE_URL+'?c=record_controller&m=read_parent_id&parent_id='+'<?=$_SESSION["doc_id"];?>');
 }
 function deny() {
 }
 ...
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=record_controller&m=delete&id=' + data.id  ;
