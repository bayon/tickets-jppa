...
fputs($fp, "	var dataString = \"c=".strtolower($objectName)."_controller&m=readToJSONByParentId&data_only=true\";\n ");
...
fputs($fp, "		html += \"<div class='row'><h2>\" + table_header + \"</h2></div>\";\n ");
 // CALL TO DETAILS LEVEL build this anchor link 
//////////////////////////////////////////////////////////////////
fputs($fp, "html += \"<div class='row'><h3><a  style='color:green;' href='<?=BASE_URL;?>index.php?c=".strtolower($childName)."_controller&m=read_parent_id&parent_id=\"+TABLE_DATA[i]['id']+\"'> details </a></h3></div> \"; ");
fputs($fp, "html += \"<input type='hidden' id='id'  name='id' class='info' value='\"+TABLE_DATA[i]['id']+\"' />\";");
fputs($fp, "html += \"<input type='hidden' id='parent_id'  name='parent_id' class='info' value='\"+TABLE_DATA[i]['parent_id']+\"' />\"; ");
///////////////////////////////////////////////////////////////
